...
hmri_def.centre = 'douglasCIC' ; % 'fil', 'lren', 'crc', 'sciz', 'cbs', ...
hmri_def.scanner = 'brukerBiospec7030' ; % e.g. 'prisma', 'allegra', 'terra', 'achieva', ...
...
% ADVANCED USER ONLY.
%--------------------------------------------------------------------------
hmri_def.RFsens.smooth_kernel = 1.2;
...
hmri_def.qMRI_maps_thresh.A        = 10^7; % [a.u.] based on input images with intensities ranging approx. [0 4096].
hmri_def.qMRI_maps_thresh.R2s      = 400;   % 1000*[s-1]
hmri_def.qMRI_maps_thresh.MTR      = 500;
hmri_def.qMRI_maps_thresh.MTR_synt = 500;
hmri_def.qMRI_maps_thresh.MT       = 50;    % [p.u.]
...
% 8) 150um mouseMPM protocol - first iteration of the mouseMPM protocol
